...
Specify directory on your machine containing data (ends with 'nowitna/data') and code (ends with 'nowitna/code')
```{r}
...
View composite record.
```{r pressure, echo=FALSE}
plot(composite.df$yrBP,composite.df$lowMean)
```
