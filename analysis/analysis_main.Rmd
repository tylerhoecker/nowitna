...
```{r}
char.ldf <- lapply(paste0(dataDir,lakes,'_charResults.csv'),read.csv)   
...
```{r}
observed.df <- read.csv('data/manual_fires_observed.csv')
...
## At this point load prepared composite biomass burning records.


## Derive composite charcoal record.
This portion runs R scripts that calculate a composite record of biomass burning based on all of the records in the region together. This code is used with permission from Ryan Kelly
